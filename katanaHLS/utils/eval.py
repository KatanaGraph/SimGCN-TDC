# This class is modeled after the DGL lifescience class called Meter()  
...
from sklearn.metrics import roc_auc_score, precision_recall_curve, auc, average_precision_score, mean_absolute_error
...
class Evaluator(object):
    ...
    def spearman(self, reduction='none'):
        """Compute Spearman correlation coefficient with associated p-value.
    ...
    def mae(self, reduction='none'):
        ...
        def score(y_true, y_pred):
            ...
            return mean_absolute_error (y_true.numpy(), y_pred.numpy())
    ...
    def compute_metric(self, metric_name, reduction='none'):
        ...
        if metric_name == 'r2':
            ...
            return self.spearman(reduction)
